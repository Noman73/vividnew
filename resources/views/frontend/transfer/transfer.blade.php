...
@section('content')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Balance Transfer</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              @endif
              <form action="{{URL::to('user/transfer')}}" method="POST">
                @csrf
                <h6><span class="text-danger">for Transfer your balance must be </span><span class="text-success font-weight-bold">200</span><span class="text-danger">TAKA</span>  </h6>
