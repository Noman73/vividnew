...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Share Balance To Wallet Transfer</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('store.share.transfer') }}" method="POST">
                            @csrf
                            <h5>
                                <span class="text-dark">Your Current Wallet Balance is :
                                    <span class="text-dark font-weight-bold">{{ isset($sharebalance) ? $sharebalance : null }} Tk</span>
                                </span>
                            </h5>
                            <h5>
