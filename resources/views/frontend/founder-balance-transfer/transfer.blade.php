...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Founder Balance To Wallet Transfer</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('founder.transfer.balance') }}" method="POST">
                            @csrf
                            <h5>
                                <span class="text-dark">Your Founder Balance is :
                                    <span class="text-dark font-weight-bold">{{ isset($currentbal) ? $currentbal : null }} Tk</span>
                                </span>
                            </h5>
                            <h5>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control " id="ammount" placeholder="Amount" name="amount">
                                </div>
                            </div>
