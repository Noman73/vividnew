...
<div class="container">
    <div class="card m-0">
        <div class="card-header pt-3  flex-row align-items-center justify-content-between">
            <h5 class="m-0 font-weight-bold">Stockiest</h5>
        </div>
        <div class="card-body px-3 px-md-5">
            <a href="{{ URL::to('admin/stockiest') }}" class="btn btn-primary" onclick="addNew()">
...
<script type="text/javascript">
    ...
    $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ URL::to('/admin/stockiest_list') }}"
        },
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
