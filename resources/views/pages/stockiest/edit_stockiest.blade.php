            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('stockiest.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Full Name  -->
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Enter Company Name" value="{{ $data->company_name }}">
                                </div>
                            </div>
                            <!-- User Id -->
                            <div class="mb-3 row">
