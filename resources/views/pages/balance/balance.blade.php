                        ...
                        <form action="{{ URL::to('/admin/balance') }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <span class="font-weight-bold small text-success" id="name"></span>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="" placeholder="Amount" name="ammount">
                                </div>
                            </div>
                            <div class="col-sm-10">
...
@section('script')
    ...
    <script>
        $("#user").on('change', function() {
            var user = $("#user").val();
            $.get("{{ route('getUser', '') }}/" + user, function(data) {
                data = JSON.parse(data);
                data.forEach(function(element) {
                    $("#name").html("<span class='font-weight-normal text-success'>User Name: </span>" + element.name);
                });
            });
        })
    </script>
