        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
	              ...
	              @endif
              <form action="{{URL::to('admin/orphan')}}" method="post" enctype="multipart/form-data">
              	@csrf
                <!-- Full Name  -->
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" id="ammount" name="ammount" placeholder="Enter Ammount" >
                  </div>
                </div>
                <!-- Status -->
                <div class="mb-3 row">
