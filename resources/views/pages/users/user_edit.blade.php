                ...
                <div class="card-body">
                    ...
                    <form action="{{ URL::to('admin/fuser') }}" method="post" id='myForm' enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Full Name" value='{{ $data->name }}'>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="username" id="username" value="{{ $data->username }}" readonly disabled>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nid" name="nid" placeholder="Enter Nid" value='{{ $data->nid }}'>
                            </div>
                        </div>
                        {{-- birthdate --}}
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="birth_date" name="birth_date" placeholder="Enter Birth Date" value='{{ $data->birth_date }}'>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter Phone Number" value="{{ $data->mobile }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="t-pin" name='t-pin' placeholder="Enter t_pin" value="{{ $data->t_pin }}">
                            </div>
                        </div>
                        <div>
                            <div class="mb-3 row">
